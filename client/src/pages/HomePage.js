...
const HomePage = () => {
  ...
  // get all transactions on component mount and when dependencies change
  useEffect(() => {
    getAllTransactions();
      ...
      <div className="filters">
        <div>
          ...
          {frequency === "custom" && (
            <RangePicker
              value={selectedDate}
              onChange={(dates) => setSelectedate(dates)}
            />
          )}
        </div>
        ...
        >
          ...
          <Form.Item label="Category" name="category" rules={[{ required: true, message: 'Please select the category!' }]}>
            <Select>
              ...
              <Select.Option value="eEducation">Education</Select.Option>
              <Select.Option value="Insurance">Insurance</Select.Option>
              <Select.Option value="Savings">Savings</Select.Option>
              <Select.Option value="Gifts_donations">Gifts & Donations</Select.Option>
